/* Copyright (C) 2019 by Regis Rousseau */
/* I2C code in order to interface BME680 to Raspberry Pi Zero W and Solar Pi_Platter board
/* Read the BME680 sensor with the Bosch's library */
/* Read temperature, pressure, humidity and gas sensor ohmic values */
...
/* definitions */
#define     DESTZONE    "TZ=Europe/Paris"
...
/* read data from BME680 sensor and load in rslt register */
...
/* write data from rslt regsiter to i2c bus */
...
/* write result to a specific file if we want */
...
int main(int argc, char *argv[] )
{
	...
	int delay = 30;  // delay between two measure in seconds
	int nMeas = 3;  // number of measures before program terminated
